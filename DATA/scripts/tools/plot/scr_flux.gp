...
#
#sinks sample
#        splot file every :100:30:100:70 u 2:4:((\$9 - \$12)/1) w l,\
#		file every :100:30:100:70 u 2:4:((\$10 - \$13)/1) w l,\
#		file every :100:30:100:70 u 2:4:((\$11 - \$14)/1) w l

#sinks lattice
#		splot file every :100:30:100:70 u 2:4:((\$15 - \$18*1)/1) w l,\
#		file every :100:30:100:70 u 2:4:((\$16 - \$19*1)/1) w l,\
#		file every :100:30:100:70 u 2:4:((\$17 - \$20*1)/1) w l
...
#profiles
#        splot file every :100:0:100:100 u 2:4:(\$6/(\$6+\$7+\$8)) w l,\

splot file every :100:0:100:100 u 2:4:(\$7/(\$6+\$7+\$8)) w l,\
		file every :100:0:100:100 u 2:4:(\$8/(\$6+\$7+\$8)) w l

#lattice + sample
#        splot file every :100:0:100:100 u 2:4:((\$15 + \$9)/1) w l,\
#		file every :100:0:100:100 u 2:4:((\$16 + \$10)/1) w l,\
#		file every :100:0:100:100 u 2:4:((\$17 + \$11)/1) w l
...
#sample
#        splot file every :100:30:100:70 u 2:4:((\$9 + \$12*0)/1) w l,\
#		file every :100:30:100:70 u 2:4:((\$10 + \$13*0)/1) w l,\
#		file every :100:30:100:70 u 2:4:((\$11 + \$14*0)/1) w l
